...
export function PricingSection({ initialPricing }: Props) {
    ...
    return (
        ...
        >
            <div className="flex items-start gap-3">
                ...
                <div>
                    ...
                    <p className="text-[13px] m-0 max-w-lg" style={{ color: '#9ca3b8', lineHeight: 1.5 }}>
                        Define el precio total, las cuotas y el interés. Los alumnos verán estas opciones al momento de inscribirse.
                    </p>
                </div>
            </div>
                ...
                {count <= 1 ? (
                    <div className="flex items-center justify-between">
                        ...
                        <span className="text-sm font-bold text-on-surface">
                            {centsToCurrency(totalCents)} EUR
                        </span>
                    </div>
                ) : (
            ...
            >
                {saving ? 'Guardando...' : 'Guardar configuración de precios'}
            </button>
        </section>
    )
}
